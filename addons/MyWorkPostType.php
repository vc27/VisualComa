 ...
 * @updated 00.00.13
 **/
$MyWorkPostType = new MyWorkPostType();
class MyWorkPostType {
	...
	function register_post_type() {
		...
		$this->registered = register__post_type( array(
			'post_type' => array(
				'labels' => array(
					'name' => __( 'My Work', 'childtheme' ),
					'singular_name' => __( 'My Work', 'childtheme' ),
					'add_new' => __( 'Add New', 'childtheme' ),
					'add_new_item' => __( 'Add New', 'childtheme' ),
					'edit_item' => __( 'Edit My Work', 'childtheme' ),
					'new_item' => __( 'New My Work', 'childtheme' ),
					'view_item' => __( 'View My Work', 'childtheme' ),
					'search_items' => __( 'Search My Work', 'childtheme' ),
					'not_found' => __( 'No My Work found', 'childtheme' ),
					'not_found_in_trash' => __( 'No My Work found in Trash', 'childtheme' ), 
					'parent_item_colon' => '',
					'menu_name' => __( 'My Work', 'childtheme' )
				),
				...
				// 'menu_position' => null,
				// 'menu_icon' => get_stylesheet_directory_uri() . "/addons/PostTypes/images/my-work-16x16.png", // is set in class construct
				...
				// 'taxonomies' => array('post_tag', 'my-work-tax-hierarchal'), // array of registered taxonomies
				...
				'query_var' => 'my-work', // This goes to the WP_Query schema
				'can_export' => true,
